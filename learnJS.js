...
describe("the JavaScript language", function(){
  describe("when coercing values", function(){
    ...
    it("concatenate two strings with plus operator", function(){
        expect("AA" + "BB").toEqual("AABB");
    });

    it("DOESN'T concatenate two arrays with plus operator", function(){
        expect([1,2] + [3,4]).toEqual("1,23,4");
    });

    it ("makes the product between booleans in 0 and 1 terms",function(){
        expect(true*false).toEqual(0);
    });

    it ("multiplies integer and boolean value",function(){
        expect(5*false).toEqual(0);
    });

    it("concatenate a boolean and a string",function(){
        expect("A" + true).toEqual("Atrue")
    });

    it("concatenate a string and a boolean",function(){
        expect(true + "A").toEqual("trueA")
    });

    it("has two different types of infinites", function(){
        var a = -1/0
        var b = 1/0
  ...
  describe("when using functions", function(){
    ...
    it("hoists variables the way you probably dont expect", function(){
        ...
        function generate(){
          var functions = [];
          for (var i = 0; i < 5; i++){
            functions.push(generateFunction(i));
          }
          return functions;
        }
        //[0,1,2,3,4,5]
  ...
  describe("when using objects", function(){
    ...
    it("can have have methods in the prototype", function(){
        ...
        expect(obj.theName).toBe(new Obj());
    });
    ...
    it("can define a factory", function(){
        ...
        expect(instance.theName).not.toBe(obj());
    });
